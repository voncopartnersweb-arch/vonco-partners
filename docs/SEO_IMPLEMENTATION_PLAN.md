...
Каталог переведено на числові тарифи тижневої оренди за регіонами. Орієнтовну вартість автомобіля та суму викупу видалено з публічних даних; ці умови менеджер формує індивідуально.
...
2. Зберігати структуровані тарифи тижневої оренди за регіонами; вартість автомобіля та орієнтовну суму викупу в каталозі не публікувати.
