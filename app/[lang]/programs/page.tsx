...
export default async function ProgramsPage({ params }: PageProps) {
  ...
  const faq = [
    { q: content.availabilityTitle, a: content.availabilityText },
    ...
    <main className={styles.page}>
      ...
      <div className={styles.container}>
        ...
        <aside className={styles.noticeBlock} aria-labelledby='program-availability'>
          <h2 id='program-availability' className={styles.noticeTitle}>{content.availabilityTitle}</h2>
          <p className={styles.noticeText}>{content.availabilityText}</p>
        </aside>
