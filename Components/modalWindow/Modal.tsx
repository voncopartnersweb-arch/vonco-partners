...
export default function Modal({ isOpen, onClose, children }: ModalProps) {
  ...
  return (
    <div className='fixed inset-0 z-[2000] flex h-dvh items-center justify-center bg-black/80 p-4 backdrop-blur-xl' onClick={onClose}>
      <div className='relative max-h-[calc(100dvh-32px)] w-full max-w-[600px] overflow-y-auto rounded-3xl border border-line bg-surface-raised px-6 pb-6 pt-12 text-foreground shadow-2xl shadow-red-950/25' onClick={(e) => e.stopPropagation()}>
        <button
