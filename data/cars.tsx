...
export const cars: readonly Car[] = [
  ...
  },
  {
    ...
    year: '2014–2016',
    image: '/VoncoCars/Toyota_Prius_Plus.webp',
    fuel: 'Hybrid + LPG',
    gearbox: 'Automatic',
    engine: '1.8 Hybrid',
    body: 'Wagon',
  ...
  },
  {
    ...
    name: 'Toyota Corolla',
    year: '2019–2022',
    image: '/VoncoCars/Corolla.webp',
    galleryImages: ['/VoncoCars/Corolla_sedan.webp', '/cars/image.webp'],
    fuel: 'Hybrid + LPG',
    gearbox: 'Automatic',
    engine: '1.8 Hybrid',
    body: 'Sedan',
  ...
  },
  {
    ...
    name: 'Toyota Camry',
    year: '2019–2022',
    image: '/VoncoCars/Toyota_Camry.webp',
    fuel: 'Hybrid + LPG',
    gearbox: 'Automatic',
