...
export const cars: readonly Car[] = [
  ...
  },
  {
    ...
    range: '850 km',
    trunkVolume: '505 L',
    rideCategories: ['UberX', 'Bolt', 'Uber Green', 'Bolt Green', 'Uber XL', 'Bolt XL'],
  ...
  },
  {
    ...
    range: '900 km',
    trunkVolume: '505 L',
    rideCategories: ['UberX', 'Bolt', 'Uber Green', 'Bolt Green', 'Uber Comfort', 'Bolt Comfort', 'Uber XL', 'Bolt XL'],
  ...
  },
  {
    ...
    range: '900 km',
    trunkVolume: '470 L',
    rideCategories: ['UberX', 'Bolt', 'Uber Green', 'Bolt Green', 'Uber Comfort', 'Bolt Comfort'],
    weeklyRent: { krakowRegion: 800, katowiceRegion: 850 },
  ...
  },
  {
    ...
    range: '1000 km',
    trunkVolume: '524 L',
    rideCategories: ['UberX', 'Bolt', 'Uber Green', 'Bolt Green', 'Uber Comfort', 'Bolt Comfort', 'Uber Premium'],
  ...
  },
  {
    ...
    range: '900 km',
    trunkVolume: '450 L',
    rideCategories: ['UberX', 'Bolt', 'Uber Green', 'Bolt Green', 'Uber Comfort', 'Bolt Comfort', 'Uber Premium', 'Bolt Premium'],
