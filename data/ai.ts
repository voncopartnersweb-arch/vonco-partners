...
Категорії Uber/Bolt звірені з офіційними вимогами 30.07.2026, але не є гарантією автоматичної активації. Вони залежать від точного року й комплектації конкретного авто, кількості місць, запису про тип пального в техпаспорті, міста, рейтингу водія, стану автомобіля та фінальної перевірки платформи. Якщо користувач питає про гарантований допуск, поясни цю залежність і направ до менеджера.
${buildFleetKnowledge()}
