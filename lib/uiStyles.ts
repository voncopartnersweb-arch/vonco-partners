...
export const pageStyles = {
  ...
  badge: 'mb-4 inline-flex rounded-full border border-brand/30 bg-brand-soft px-3 py-1 text-xs font-bold tracking-wider text-brand uppercase',
  ...
  reviewBox: 'mt-6 rounded-2xl border border-brand/30 bg-brand-soft p-4 text-sm leading-6 text-muted [&_strong]:mb-1 [&_strong]:block [&_strong]:text-foreground',
...
export const chatStyles = {
  ...
  input: 'h-11 min-w-0 flex-1 rounded-xl border border-line bg-background px-3 text-sm text-foreground outline-none focus:border-brand focus:ring-4 focus:ring-brand/10',
...
export const contactModalStyles = {
  ...
  eyebrow: 'mb-1 text-xs font-black tracking-[0.14em] text-accent uppercase',
  ...
  socials: 'mt-2 grid grid-cols-3 gap-2 [&_a]:inline-flex [&_a]:min-h-11 [&_a]:items-center [&_a]:justify-center [&_a]:gap-2 [&_a]:rounded-xl [&_a]:border [&_a]:border-line [&_a]:bg-surface [&_a]:px-2 [&_a]:text-sm [&_a]:font-bold [&_a]:text-foreground [&_a]:transition [&_a:hover]:border-brand/60 [&_a:hover]:bg-brand-soft',
  ...
  mapAction: 'inline-flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl border border-line bg-surface-raised px-3 text-sm font-extrabold text-foreground transition hover:border-brand/60 hover:bg-brand-soft',
